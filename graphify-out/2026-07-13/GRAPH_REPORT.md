# Graph Report - New-OneLuxStay  (2026-07-13)

## Corpus Check
- 311 files · ~1,096,927 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 33760 nodes · 66075 edges · 3622 communities (3610 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b88f4e7`
...
1. `DubaiLandingPage` - 176 edges
2. `LosAngelesLandingPage` - 162 edges
3. `supabaseRestRequest()` - 92 edges
4. `handler()` - 80 edges
5. `audits` - 74 edges
6. `audits` - 74 edges
7. `audits` - 74 edges
...
- `ADA Accessibility Audit Report 2026-03-02` --references--> `DubaiLandingPage`  [EXTRACTED]
  audit-reports/ADA_AUDIT_REPORT_2026-03-02.md → src/App.jsx
- `index.html Entry Point` --references--> `OLS Logo (ols-logo.webp)`  [EXTRACTED]
  index.html → ols-logo.webp
- `City Guide Email Preview: Dubai (Text)` --semantically_similar_to--> `City Guide Email Preview: Dubai Mobile Screenshot`  [INFERRED] [semantically similar]
  audit-reports/city-guide-email-preview-dubai.txt → audit-reports/city-guide-email-preview-dubai-mobile.png
- `OLS Logo (ols-logo.webp)` --semantically_similar_to--> `OLS Logo (public/oneluxstay-logo.webp)`  [INFERRED] [semantically similar]
  ols-logo.webp → public/oneluxstay-logo.webp
- `ensureSchema()` --calls--> `supabaseRestRequest()`  [EXTRACTED]
  scripts/supabase-sync-property-nightly-prices-from-guesty.mjs → netlify/functions/_shared/supabaseClient.js

## Import Cycles
- 1-file cycle: `src/AntwerpLandingPage.jsx -> src/AntwerpLandingPage.jsx`
- 2-file cycle: `src/App.jsx -> src/utils/routePreloaders.js -> src/App.jsx`
- 2-file cycle: `src/LandingPage.jsx -> src/utils/routePreloaders.js -> src/LandingPage.jsx`
- 3-file cycle: `src/App.jsx -> src/utils/routePreloaders.js -> src/LosAngelesLandingPage.jsx -> src/App.jsx`
- 3-file cycle: `src/App.jsx -> src/utils/routePreloaders.js -> src/DubaiLandingPage.jsx -> src/App.jsx`

## Communities (3622 total, 12 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (97): description, details, id, score, scoreDisplayMode, title, details, details (+89 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (141): Card, CardSwap, Step(), useInlineListingMap(), LosAngelesLandingPage, addMonths(), AMENITY_GROUP_ICON_MAP, AMENITY_GROUPS (+133 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (109): getQuotePricing(), getQuotePricing(), getQuotePricing(), AMENITY_GROUPS, BUILDING_GROUPS, buildNormalizedCalendarDaysByListing(), buildWhatsAppLink(), CHECKOUT_PROMO_CODES (+101 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (147): normalizeCalendarDay(), DubaiLandingPage, addMonths(), AMENITY_GROUPS, BedIcon(), buildCalendarMonth(), buildCalendarPayload(), buildDateAvailabilityMapFromCalendars() (+139 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (106): RedondoBeachPrimaryPage, AMENITY_GROUPS, BUILDING_GROUPS, buildNormalizedCalendarDaysByListing(), buildShortStayInquiryMessage(), buildWhatsAppLink(), CHECKOUT_PROMO_CODES, CITY_TOUR_SLIDES (+98 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (54): axe-core, environment, benchmarkIndex, credits, hostUserAgent, networkUserAgent, fetchTime, finalDisplayedUrl (+46 more)
...
Cohesion: 0.03
Nodes (104): ADDRESS_OVERRIDES, AMENITY_GROUPS, ANTWERP_CONTACT_PROFILE, ANTWERP_REVIEWS, AntwerpLandingPage(), BUILDING_GROUPS, buildNormalizedCalendarDaysByListing(), buildWhatsAppLink() (+96 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (33): axe-core, environment, benchmarkIndex, credits, hostUserAgent, networkUserAgent, fetchTime, finalDisplayedUrl (+25 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (88): buildActorNameFilter(), buildConversationModePatch(), buildConversationTranscript(), buildCreatedAtFilter(), buildDeterministicConversationSummary(), buildGuestJourneyFilters(), buildLessonActorFields(), buildLessonActorFilter() (+80 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (31): axe-core, environment, benchmarkIndex, credits, hostUserAgent, networkUserAgent, fetchTime, finalDisplayedUrl (+23 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (66): src/AntwerpLandingPage.jsx, src/App.css, src/BookingConfirmationPage.jsx, src/CheckoutCancelledPage.jsx, src/LandingPage.jsx, ADA Accessibility Audit Report 2026-03-02, src/LosAngelesLandingPage.jsx, src/MiamiBeachLandingPage.jsx (+58 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (21): configSettings, maxWaitForFcp, maxWaitForLoad, output, pauseAfterFcpMs, pauseAfterLoadMs, axe-core, environment (+13 more)
...
Cohesion: 0.07
Nodes (86): CITY_PATHS, extractButtonContext(), normalizeText(), ChatConcierge(), SiteFooter(), HIDDEN_UNIT_IDS, baseMetadata(), canUseDom() (+78 more)
...
Cohesion: 0.03
Nodes (83): details, details, description, details, id, score, scoreDisplayMode, title (+75 more)
...
Cohesion: 0.03
Nodes (90): details, details, description, details, id, score, scoreDisplayMode, title (+82 more)
...
Cohesion: 0.07
Nodes (50): details, color-contrast, landmark-one-main, link-name, listitem, meta-viewport, description, details (+42 more)

### Community 68 - "Community 68"
Cohesion: 0.05
Nodes (63): details, heading-order, html-has-lang, html-lang-valid, landmark-one-main, link-name, list, meta-viewport (+55 more)

### Community 69 - "Community 69"
Cohesion: 0.03
Nodes (83): details, details, details, description, details, id, score, scoreDisplayMode (+75 more)
...
Cohesion: 0.14
Nodes (34): description, details, id, score, scoreDisplayMode, title, details, details (+26 more)

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (34): details, details, details, details, details, description, details, id (+26 more)
...
Cohesion: 0.06
Nodes (62): handler(), buildSuccessUrl(), handler(), isLocalDebugRequest(), buildBookingRecord(), buildGuest(), constructStripeEvent(), handler() (+54 more)

### Community 78 - "Community 78"
Cohesion: 0.04
Nodes (85): baseHeaders, buildGuestyUrl(), DEFAULT_LISTING_FIELDS, fetchWithTimeout(), getBlobStore(), getCorsHeaders(), getGuestyToken(), guestyRequest() (+77 more)

### Community 79 - "Community 79"
Cohesion: 0.07
Nodes (60): buildConsentPdf(), buildReservationNotes(), buildReservationPayload(), claimStripeSessionProcessing(), createGuestyInvoiceItem(), createGuestyReservation(), createGuestyReservationFromQuote(), createMinimalGuestyReservationPayload() (+52 more)

### Community 80 - "Community 80"
Cohesion: 0.06
Nodes (89): isHiddenUnit(), normalizeReservationToken(), addMonths(), applyGuestyCouponsToQuote(), applySecurityDepositToAmount(), buildConsentPdf(), buildGuestyReservationPayload(), buildPaidConfirmationRedirectUrl() (+81 more)

### Community 81 - "Community 81"
Cohesion: 0.09
Nodes (51): handler(), isTruthy(), handler(), APALEO_API_BASE, APALEO_IDENTITY_URL, apaleoRequest(), buildApaleoUrl(), buildFullName() (+43 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (44): addDaysIso(), chunkAvailability(), DEFAULT_DAYS, escapeXml(), FALLBACK_AVAILABILITY_TABLES, fetchAvailRows(), handler(), isDateConsecutive() (+36 more)

### Community 83 - "Community 83"
Cohesion: 0.03
Nodes (90): details, description, details, id, score, scoreDisplayMode, title, description (+82 more)

### Community 84 - "Community 84"
Cohesion: 0.04
Nodes (42): DateRangePicker(), diffNights(), firstNumber(), formatAddress(), formatDisplayDate(), getBuildingKey(), getImageUrl(), getListingImages() (+34 more)

### Community 85 - "Community 85"
Cohesion: 0.03
Nodes (94): isSuperAdminSession(), ProtectedSuperAdminRoute(), API_BASE, ADMIN_ROLES, GENERIC_AUTH_ROLES, getNormalizedUserRole(), getSuperAdminEmails(), hasSuperAdminEmail() (+86 more)

### Community 86 - "Community 86"
Cohesion: 0.03
Nodes (83): details, description, details, id, score, scoreDisplayMode, title, details (+75 more)

### Community 87 - "Community 87"
Cohesion: 0.09
Nodes (25): buildLanguageProfile(), buildSentimentAwareReply(), CHAT_INTENTS, CHAT_TOOLS, collapseIsoDatesToRanges(), defaultAcknowledgementBySentimentByLocale, detectGuestLanguageProfile(), detectLanguageFromText() (+17 more)

### Community 88 - "Community 88"
Cohesion: 0.13
Nodes (38): fetchSessionMessages(), getCorsHeaders(), getEnv(), getHeaderValue(), getSourceOrigin(), getTables(), handler(), isLearningEnabled() (+30 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (40): clampText(), escapeXml(), handler(), normalizeString(), PARTNER_KEY, toInteger(), xmlResponse(), getEnv() (+32 more)

### Community 90 - "Community 90"
Cohesion: 0.10
Nodes (38): APPLY, args, buildPropertyAddressKey(), buildPropertyNameKey(), chooseBestCandidate(), DEBUG_AMBIGUOUS, DISTANCE_METERS, extractPropertyUnitToken() (+30 more)

### Community 91 - "Community 91"
Cohesion: 0.05
Nodes (45): FOOTER_CITY_LINKS, FOOTER_EXPLORE_LINKS, FOOTER_LEGAL_LINKS, FOOTER_SECURITY_ITEMS, FOOTER_TRUST_BADGES, getFooterContactItems(), handleFooterCityClick(), isAntwerpPath() (+37 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (71): CallsPage(), formatDateTime(), formatDuration(), formatPhone(), getCountryLabel(), getStatusLabel(), getStatusModifier(), DEFAULT_FORM (+63 more)

### Community 93 - "Community 93"
Cohesion: 0.10
Nodes (26): cityLabelFromPath(), createLocalId(), createSessionId(), DEFAULT_SUGGESTIONS, detectPageType(), extractListingId(), getAutoAvailabilityFromSearch(), getOrCreateSessionId() (+18 more)

### Community 94 - "Community 94"
Cohesion: 0.08
Nodes (20): APPLY, args, batch, BATCH_SIZE, calendars, eligible, endDate, ensureSchema() (+12 more)

### Community 95 - "Community 95"
Cohesion: 0.12
Nodes (13): App, autoBind(), canUseWebGL(), CircularGallery(), clamp(), createTextTexture(), debounce(), DEFAULT_GALLERY_ITEMS (+5 more)
...
Cohesion: 0.12
Nodes (37): addUtcDays(), handler(), isTruthy(), toIsoDate(), handler(), isTruthy(), handler(), isTruthy() (+29 more)

### Community 98 - "Community 98"
Cohesion: 0.10
Nodes (54): buildSessionIdFromPhone(), getChatTables(), getEnv(), getTwilioSmsAuthConfig(), getTwilioWhatsAppAuthConfig(), handler(), jsonResponse(), normalizeSmsAddress() (+46 more)

### Community 99 - "Community 99"
Cohesion: 0.07
Nodes (29): argv, baseUrl, checkIn, checkOut, __dirname, __filename, fullName, outDir (+21 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (32): buildAvailabilityLinksReply(), buildDeterministicPolicyReply(), buildLearningText(), buildRetrievedPolicyText(), buildSentimentLearningText(), detectPrimaryIntent(), extractBedroomPreferenceFromText(), extractGuests() (+24 more)
...
Cohesion: 0.17
Nodes (26): getEnv(), handler(), jsonResponse(), sanitizeId(), sanitizeString(), COUNTRY_ALIASES, CURRENCY_ALIASES, FALLBACK_CURRENCY_BY_COUNTRY (+18 more)

### Community 103 - "Community 103"
Cohesion: 0.17
Nodes (27): buildDeterministicFallbackAnswer(), buildFunctionBase(), buildSnapshot(), buildSnapshotText(), createAssistantReply(), encodeGuestyQuery(), enforceExecutiveAccess(), extractOutputText() (+19 more)

### Community 104 - "Community 104"
Cohesion: 0.16
Nodes (17): addBed(), addBedsFromText(), BED_LABELS, BED_PATTERNS, BEDROOM_WORDS, extractBedroomBedDetails(), extractTextSources(), formatBedDetailText() (+9 more)

### Community 105 - "Community 105"
Cohesion: 0.14
Nodes (26): boolString(), buildFeedXml(), buildWebsiteUrl(), DEFAULT_CATEGORY, DEFAULT_COUNTRY, DEFAULT_PHONE, escapeXml(), FEED_MAX_ROWS (+18 more)

### Community 106 - "Community 106"
Cohesion: 0.05
Nodes (36): buildAttractionDocs(), createEmbedding(), getAllDocs(), getEnv(), handler(), sleep(), toVectorLiteral(), upsertDocument() (+28 more)

### Community 107 - "Community 107"
Cohesion: 0.10
Nodes (23): absoluteUrlForPath(), appRoutesFile, BLOG_POST_SLUGS, buildRouteSet(), buildXml(), CITY_CONFIG, defaultCheckIn, defaultCheckOut (+15 more)

### Community 108 - "Community 108"
Cohesion: 0.20
Nodes (26): buildAgentInput(), buildInstructions(), buildKnowledgeBlock(), buildLocalFallbackAnswer(), createAssistantReply(), createCheckoutLink(), createEmbedding(), extractOutputText() (+18 more)

### Community 109 - "Community 109"
Cohesion: 0.08
Nodes (25): dependencies, concurrently, cors, dotenv, @fontsource/cormorant-garamond, @fontsource/work-sans, gsap, leaflet (+17 more)

### Community 110 - "Community 110"
Cohesion: 0.14
Nodes (21): buildDestinationRecommendationReply(), buildListingPriceReply(), buildMonthAvailabilityReply(), buildSmallTalkReply(), buildUnitInfoReply(), extractNearestLandmarks(), extractQuotePricingForChat(), fetchFunctionJson() (+13 more)

### Community 111 - "Community 111"
Cohesion: 0.13
Nodes (14): FinError(), formatDateTime(), formatGuestAddress(), formatJson(), GuestTab(), nightsBetween(), normalizeStatus(), OverviewTab() (+6 more)

### Community 112 - "Community 112"
Cohesion: 0.17
Nodes (22): addDaysIso(), chunkRates(), DEFAULT_DAYS, DEFAULT_GUESTS, escapeXml(), FALLBACK_AVAILABILITY_TABLES, fetchNightlyRateRows(), handler() (+14 more)

### Community 113 - "Community 113"
Cohesion: 0.06
Nodes (78): ChromaGrid(), DEFAULT_ITEMS, optimizeChromaImage(), getCorsHeaders(), getEnv(), getHeaderValue(), getSourceOrigin(), getTable() (+70 more)

### Community 114 - "Community 114"
Cohesion: 0.09
Nodes (23): scripts, build, dev, dev:client, dev:netlify, email:preview:city-guide, email:send:city-guide-test, google:ari:debug (+15 more)

### Community 115 - "Community 115"
Cohesion: 0.16
Nodes (19): buildSearch(), APPLY, args, buildSearchQuery(), COUNTRY_BIAS, fetchJson(), geocodeNominatim(), main() (+11 more)

### Community 116 - "Community 116"
Cohesion: 0.22
Nodes (16): ApaleoTestPage(), formatJson(), statusClass(), fetchApaleoAccount(), fetchApaleoAvailability(), fetchApaleoFinancials(), fetchApaleoProperties(), fetchApaleoReservations() (+8 more)

### Community 117 - "Community 117"
Cohesion: 0.12
Nodes (18): allListings, batch, batchSize, dedup, listingId(), listingsTable, normalizeString(), pageLimit (+10 more)

### Community 118 - "Community 118"
Cohesion: 0.11
Nodes (52): getHeaders(), handler(), jsonResponse(), safeLogAdminsOlsActivity(), sanitizeString(), DEFAULT_TIERS, DEFAULTS, getConfigStore() (+44 more)

### Community 119 - "Community 119"
Cohesion: 0.20
Nodes (17): baseHeaders, buildGuestyUrl(), buildIdVariants(), fetchWithTimeout(), getBlobStore(), getCorsHeaders(), getGuestyToken(), guestyRequest() (+9 more)

### Community 120 - "Community 120"
Cohesion: 0.17
Nodes (14): fmt(), formatShortDate(), nights(), resolveStatus(), STATUS_MAP, toIso(), matchesArrival(), matchesStatus() (+6 more)

### Community 121 - "Community 121"
Cohesion: 0.05
Nodes (63): details, heading-order, html-lang-valid, image-alt, landmark-one-main, link-name, list, listitem (+55 more)

### Community 122 - "Community 122"
Cohesion: 0.30
Nodes (8): BlogCard(), RelatedArticles(), getBlogPost(), getRelatedPosts(), BlogArticlePage(), buildBreadcrumbSchema(), buildFaqSchema(), formatPublishDate()

### Community 123 - "Community 123"
Cohesion: 0.53
Nodes (5): allowedOrigins, buildCorsHeaders(), handler(), response(), safeRequest()

### Community 124 - "Community 124"
Cohesion: 0.16
Nodes (21): addDays(), addIsoDays(), buildAvailabilityQuickReplies(), buildMonthRange(), extractDateRange(), extractDatesFromText(), extractMonthRange(), fetchAvailableDatesForMonth() (+13 more)
...
Cohesion: 0.19
Nodes (10): computeNights(), handler(), jsonResponse(), num(), ReservationModal(), fmt(), ReservationPricing(), computeNights() (+2 more)

### Community 127 - "Community 127"
Cohesion: 0.08
Nodes (36): canUseSessionStorage(), decodeJwtPayload(), deletePresenceRow(), generateSessionId(), getActiveRuntimeCounts(), getNextClientInstanceId(), getNextHookInstanceId(), getOrCreatePresenceSession() (+28 more)

### Community 128 - "Community 128"
Cohesion: 0.14
Nodes (7): clamp(), getSpotlightRect(), CITY_DETAIL_STEPS, CITY_PATH_PREFIXES, CITY_ROOT_STEPS, HOME_COMMON_STEPS, HOME_FEATURED_STEP

### Community 129 - "Community 129"
Cohesion: 0.13
Nodes (11): approxBytes, candidateRaw, candidates, EXTRA_DYNAMIC_KEYS, files, FUNCTIONS_DIR, required, source (+3 more)

### Community 130 - "Community 130"
Cohesion: 0.37
Nodes (11): getFeaturedPost(), getPostsByCategory(), BlogPage(), CANONICAL, SearchIcon(), buildBlogListSchema(), buildBlogPostSchema(), buildCanonicalUrl() (+3 more)

### Community 131 - "Community 131"
Cohesion: 0.14
Nodes (10): conciergeKnowledge, __dirname, __filename, now, reviews, root, rows, siteContentTable (+2 more)

### Community 132 - "Community 132"
Cohesion: 0.05
Nodes (58): description, details, id, score, scoreDisplayMode, title, description, details (+50 more)

### Community 133 - "Community 133"
Cohesion: 0.14
Nodes (14): devDependencies, autoprefixer, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, jsrepo (+6 more)

### Community 134 - "Community 134"
Cohesion: 0.14
Nodes (12): batch, embedBatchSize, embeddingModel, fetchAllSections(), inputs, openAiApiKey, pageSize, reembedAll (+4 more)
...
Cohesion: 0.21
Nodes (13): aiDocuments, buildAiDocumentDocs(), buildAiDocumentDocs(), documentsTable, escapeEq(), findDocument(), findSection(), request() (+5 more)

### Community 137 - "Community 137"
Cohesion: 0.18
Nodes (11): Analytics Events (src/lib/analyticsEvents.js), Analytics Core (src/lib/analytics.js), Attribution, Core Events, Funnel Stages, GTM Migration, GTM Migration Readiness, Journey Coverage (+3 more)

### Community 138 - "Community 138"
Cohesion: 0.15
Nodes (12): buildCard(), DEFAULT_FILTERS, GuestReservationPage(), matchesFilters(), ARRIVAL_FILTERS, CITIES, STATUSES, ReservationGrid() (+4 more)

### Community 139 - "Community 139"
Cohesion: 0.24
Nodes (18): ChargesTable(), fmtAmount(), fmtDate(), PaymentsTable(), sanitize(), fmtAmount(), FolioCard(), FolioPanel() (+10 more)

### Community 140 - "Community 140"
Cohesion: 0.35
Nodes (12): detectPmsProvider(), getAvailability(), getProperties(), getReservations(), isAntwerpCity(), normalizeDate(), normalizeGuestyAvailability(), normalizeGuestyProperty() (+4 more)

### Community 141 - "Community 141"
Cohesion: 0.29
Nodes (9): formatGuestAddress(), formatJson(), nightsBetween(), normalizeStatus(), readGuestsLabel(), ReservationsSection(), sanitize(), toCount() (+1 more)

### Community 142 - "Community 142"
Cohesion: 0.18
Nodes (10): A) Core pages with failures, Advisory (Not Weighted by Lighthouse Score but Important), B) Area pages with failures (all tested cities), Likely Source Files, Manual ADA Checks Still Required, Non-Compliant Pages (Automated WCAG Failures), Pages Passing Automated Weighted Accessibility Checks, Primary Issues Found (+2 more)

### Community 143 - "Community 143"
Cohesion: 0.33
Nodes (8): ArticleContent(), FaqBlock(), injectInternalLinks(), PlusIcon(), renderBlock(), TipIcon(), CITY_INTERNAL_LINKS, CITY_LINK_MAP

### Community 144 - "Community 144"
Cohesion: 0.18
Nodes (9): graphify, AI Agent (RAG + Booking Handoff), Backfilling coordinates (required for listings to emit), Development, Google ARI (Pricing + Availability), Google Vacation Rentals Feed, Netlify Function: google-vr-ari-property-data, One Lux Stay Website (+1 more)

### Community 145 - "Community 145"
Cohesion: 0.13
Nodes (18): buildCurrentTimeReply(), buildFallbackReply(), buildFallbackRescueReply(), buildInput(), buildKnowledgeText(), buildLanguageReplyInstruction(), buildReservationStatusReply(), buildSiteContext() (+10 more)
...
Cohesion: 0.38
Nodes (11): Netlify Function: ai-query.js, Netlify Function: chat-learning.js, Netlify Function: google-vr-ari-avail, Netlify Function: google-vr-ari-rate, Netlify Function: google-vr-hotel-list, One Lux Stay Website Project, Supabase Integration, Supabase Migration: 20260326_add_ai_knowledge_tables.sql (+3 more)

### Community 148 - "Community 148"
Cohesion: 0.22
Nodes (13): buildCityQuickReplies(), buildGuestQuickReplies(), buildQuickReply(), buildQuickReplySet(), buildSmartToolReply(), createEmbedding(), extractOutputText(), fetchWithTimeout() (+5 more)
...
Cohesion: 0.29
Nodes (7): buildConsentPdf(), consent, formatDateTime12h(), getVerificationEntries(), metadata, normalizeProofImage(), sanitizeText()
...
Cohesion: 0.44
Nodes (8): buildVoiceBridgeSignature(), getEnv(), handler(), normalizePhoneNumber(), readQueryValue(), sanitizeString(), xmlEscape(), xmlResponse()

### Community 153 - "Community 153"
Cohesion: 0.31
Nodes (10): buildAttentionReply(), buildFallbackOrAttentionResponse(), countGenericFallbackReplies(), countPreviousMatchingUserMessages(), fallbackNoticeFromReason(), fallbackResponse(), hasRecentAttentionHandoff(), isGenericFallbackText() (+2 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-parent, empty-heading, meta-refresh (+11 more)
...
Cohesion: 0.32
Nodes (8): getEnv(), parseEnvBoolean(), retrievePolicySections(), retrievePolicySectionsByKeyword(), retrieveRatedConversationExamples(), retrieveSentimentLessons(), tokenizeQuery(), toVectorLiteral()

### Community 158 - "Community 158"
Cohesion: 0.25
Nodes (7): 1) Keep only function-needed variables in Function scope, 2) Remove these from Function scope (or delete if unused), 3) Fast audit command, Netlify Lambda 4KB Env Limit Fix, scripts/audit-netlify-function-env.mjs, Resend Email Integration, Stripe Integration

### Community 159 - "Community 159"
Cohesion: 0.48
Nodes (5): computeNights(), handler(), jsonResponse(), num(), splitGuestName()

### Community 160 - "Community 160"
Cohesion: 0.29
Nodes (7): src/main.jsx, One Lux Stay Organisation (Schema.org), index.html Entry Point, OLS Logo (ols-logo.webp), OLS Logo (public/oneluxstay-logo.webp), src/main.jsx, public/robots.txt

### Community 161 - "Community 161"
Cohesion: 0.23
Nodes (11): allBlogPosts, BLOG_AUTHORS, BLOG_CATEGORIES, blogPosts, HIDDEN_BLOG_SLUGS, AdminBlogPage(), calcSeoScore(), EMPTY_FORM (+3 more)

### Community 162 - "Community 162"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, bypass, object-alt (+11 more)

### Community 163 - "Community 163"
Cohesion: 0.29
Nodes (6): after, before, c, end, fs, start

### Community 164 - "Community 164"
Cohesion: 0.53
Nodes (4): ArticleSidebar(), CITY_CTA, DEFAULT_CTA, TableOfContents()
...
Cohesion: 0.60
Nodes (6): extractReservationCode(), extractReservationCodeFromPrompt(), extractStrictReservationCode(), fetchReservationStatusForChat(), looksLikeReservationCode(), sanitizeReservationCode()

### Community 167 - "Community 167"
Cohesion: 0.67
Nodes (5): AuthorizationCard(), fmt(), PaymentAccountCard(), PaymentPanel(), SmallRow()
...
Cohesion: 0.50
Nodes (3): hasWebGLSupport(), Silk(), SilkPlane

### Community 171 - "Community 171"
Cohesion: 0.70
Nodes (4): getSeasonalMonthlyPrice(), getSeasonalMonthlyPricingMeta(), parseMonthNumber(), REDONDO_CUSTOM_PRICING

### Community 172 - "Community 172"
Cohesion: 0.70
Nodes (4): getHeaderValue(), handler(), jsonResponse(), parseFormBody()

### Community 173 - "Community 173"
Cohesion: 0.14
Nodes (13): allowScripts, esbuild@0.28.1, name, overrides, esbuild, @opentelemetry/context-async-hooks, @opentelemetry/core, @opentelemetry/resources (+5 more)

### Community 174 - "Community 174"
Cohesion: 0.40
Nodes (5): 1) Create/Apply schema, 2) Configure environment, 3) Seed/sync data, 4) Switch provider incrementally, Supabase Migration Prep

### Community 175 - "Community 175"
Cohesion: 0.70
Nodes (4): extractGuest(), formatAddress(), GuestPanel(), Row()

### Community 176 - "Community 176"
Cohesion: 0.40
Nodes (3): supabaseKey, supabaseUrl, tables

### Community 178 - "Community 178"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, empty-heading, select-name (+11 more)

### Community 179 - "Community 179"
Cohesion: 0.83
Nodes (3): getPdfStore(), handler(), jsonResponse()

### Community 180 - "Community 180"
Cohesion: 0.83
Nodes (3): clampLimit(), handler(), jsonResponse()

### Community 181 - "Community 181"
Cohesion: 0.67
Nodes (4): AI Concierge, Netlify Function: chat.js, src/data/conciergeKnowledge.js, OpenAI Integration

### Community 182 - "Community 182"
Cohesion: 0.50
Nodes (4): Guesty Integration, supabase/migrations/20260423102000_add_properties_guesty_listing_id.sql, Guesty Open API, Update Reservation Status API

### Community 183 - "Community 183"
Cohesion: 0.67
Nodes (3): Funnel Stage 1: Homepage Viewed, Funnel Stage 7: Booking Clicked, Funnel Stage 8: Booking Redirected
...
Cohesion: 0.32
Nodes (11): RoadmapPrivatePage, ALIGNMENT_ROWS, getPhaseStatus(), getProgressPercent(), ITEM_STATUS, ROADMAP_PHASES, RoadmapPrivatePage(), SectionTitle() (+3 more)

### Community 205 - "Community 205"
Cohesion: 0.06
Nodes (54): description, details, id, score, scoreDisplayMode, title, aria-hidden-body, color-contrast (+46 more)
...
Cohesion: 0.07
Nodes (50): details, html-has-lang, image-alt, landmark-one-main, link-name, target-size, details, impact (+42 more)

### Community 210 - "Community 210"
Cohesion: 0.07
Nodes (50): details, heading-order, html-has-lang, landmark-one-main, link-name, target-size, details, impact (+42 more)

### Community 211 - "Community 211"
Cohesion: 0.07
Nodes (49): details, color-contrast, document-title, html-has-lang, landmark-one-main, listitem, description, details (+41 more)
...
Cohesion: 0.14
Nodes (34): details, details, description, details, id, score, scoreDisplayMode, title (+26 more)

### Community 215 - "Community 215"
Cohesion: 0.14
Nodes (34): details, details, details, details, details, details, details, details (+26 more)
...
Cohesion: 0.17
Nodes (32): details, details, details, details, details, details, details, details (+24 more)
...
Cohesion: 0.17
Nodes (31): details, details, details, details, details, details, details, details (+23 more)
...
Cohesion: 0.18
Nodes (30): details, details, details, details, details, details, details, details (+22 more)
...
Cohesion: 0.08
Nodes (26): description, id, score, scoreDisplayMode, title, description, id, score (+18 more)
...
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-allowed-role, definition-list, select-name (+17 more)

### Community 259 - "Community 259"
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-valid-attr, dlitem, image-alt (+17 more)

### Community 260 - "Community 260"
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-command-name, document-title, duplicate-id-aria (+17 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-valid-attr, html-has-lang, meta-refresh (+11 more)

### Community 263 - "Community 263"
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-progressbar-name, focusable-controls, heading-order (+17 more)
...
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, accesskeys, identical-links-same-purpose, input-image-alt (+17 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, button-name, heading-order (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, image-alt, tabindex (+11 more)

### Community 270 - "Community 270"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-meter-name, duplicate-id-aria (+11 more)
...
Cohesion: 0.11
Nodes (19): document-title, frame-title, logical-tab-order, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): heading-order, html-xml-lang-mismatch, td-headers-attr, description, id, score, scoreDisplayMode, title (+11 more)

### Community 280 - "Community 280"
Cohesion: 0.10
Nodes (21): description, id, score, scoreDisplayMode, title, description, id, score (+13 more)

### Community 281 - "Community 281"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, image-redundant-alt, td-headers-attr (+11 more)
...
Cohesion: 0.10
Nodes (21): description, id, score, scoreDisplayMode, title, audits, aria-meter-name, object-alt (+13 more)
...
Cohesion: 0.10
Nodes (21): description, id, score, scoreDisplayMode, title, aria-text, custom-controls-labels, definition-list (+13 more)
...
Cohesion: 0.11
Nodes (19): audits, button-name, form-field-multiple-labels, input-button-name, description, id, score, scoreDisplayMode (+11 more)

### Community 294 - "Community 294"
Cohesion: 0.10
Nodes (20): form-field-multiple-labels, identical-links-same-purpose, input-button-name, list, description, id, score, scoreDisplayMode (+12 more)

### Community 295 - "Community 295"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-dialog-name, input-button-name, list (+12 more)
...
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-required-parent, identical-links-same-purpose, input-button-name (+12 more)

### Community 300 - "Community 300"
Cohesion: 0.10
Nodes (20): identical-links-same-purpose, input-button-name, list, valid-lang, description, id, score, scoreDisplayMode (+12 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, form-field-multiple-labels (+11 more)

### Community 304 - "Community 304"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-tooltip-name, frame-title, list (+12 more)

### Community 305 - "Community 305"
Cohesion: 0.11
Nodes (19): custom-controls-labels, definition-list, image-alt, description, id, score, scoreDisplayMode, title (+11 more)

### Community 306 - "Community 306"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, description, id, score (+12 more)

### Community 307 - "Community 307"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-required-parent, link-name, list (+12 more)

### Community 308 - "Community 308"
Cohesion: 0.10
Nodes (20): dlitem, html-lang-valid, list, listitem, description, id, score, scoreDisplayMode (+12 more)

### Community 309 - "Community 309"
Cohesion: 0.11
Nodes (19): empty-heading, link-name, object-alt, description, id, score, scoreDisplayMode, title (+11 more)

### Community 310 - "Community 310"
Cohesion: 0.33
Nodes (6): input-button-name, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-text, focusable-controls, input-button-name (+11 more)

### Community 313 - "Community 313"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-required-attr, dlitem, list (+12 more)

### Community 314 - "Community 314"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, audits, aria-allowed-attr, identical-links-same-purpose (+12 more)
...
Cohesion: 0.11
Nodes (19): button-name, heading-order, image-alt, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.10
Nodes (20): custom-controls-labels, input-image-alt, list, th-has-data-cells, description, id, score, scoreDisplayMode (+12 more)

### Community 322 - "Community 322"
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-hidden-focus, dlitem, list (+12 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, custom-controls-labels, td-headers-attr (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, image-redundant-alt, offscreen-content-hidden (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-valid-attr, logical-tab-order (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-attr, link-in-text-block (+11 more)

### Community 331 - "Community 331"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, empty-heading, meta-refresh (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-dialog-name, duplicate-id-aria, use-landmarks (+11 more)
...
Cohesion: 0.11
Nodes (19): empty-heading, form-field-multiple-labels, image-redundant-alt, description, id, score, scoreDisplayMode, title (+11 more)

### Community 338 - "Community 338"
Cohesion: 0.11
Nodes (19): html-xml-lang-mismatch, identical-links-same-purpose, object-alt, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.10
Nodes (21): description, id, score, scoreDisplayMode, title, audits, aria-required-parent, definition-list (+13 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, bypass, meta-refresh (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, empty-heading, identical-links-same-purpose (+11 more)

### Community 345 - "Community 345"
Cohesion: 0.10
Nodes (21): description, id, score, scoreDisplayMode, title, audits, aria-toggle-field-name, definition-list (+13 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, tabindex, table-fake-caption (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, meta-refresh, table-duplicate-name (+11 more)

### Community 353 - "Community 353"
Cohesion: 0.11
Nodes (19): bypass, empty-heading, form-field-multiple-labels, description, id, score, scoreDisplayMode, title (+11 more)

### Community 354 - "Community 354"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, bypass, form-field-multiple-labels (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, identical-links-same-purpose, skip-link (+11 more)

### Community 360 - "Community 360"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-meter-name, bypass, empty-heading (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, html-xml-lang-mismatch, tabindex (+11 more)

### Community 363 - "Community 363"
Cohesion: 0.11
Nodes (19): heading-order, html-xml-lang-mismatch, table-duplicate-name, description, id, score, scoreDisplayMode, title (+11 more)

### Community 364 - "Community 364"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, bypass, identical-links-same-purpose (+11 more)

### Community 365 - "Community 365"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, color-contrast, td-headers-attr (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-toggle-field-name, html-xml-lang-mismatch, skip-link (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, empty-heading, form-field-multiple-labels (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, table-duplicate-name, td-headers-attr (+11 more)

### Community 377 - "Community 377"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, image-redundant-alt, td-has-header (+11 more)

### Community 378 - "Community 378"
Cohesion: 0.11
Nodes (19): html-xml-lang-mismatch, identical-links-same-purpose, table-fake-caption, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-command-name, identical-links-same-purpose, list (+12 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-dialog-name, button-name (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, empty-heading, object-alt (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, meta-viewport, td-has-header (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, empty-heading, tabindex (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, button-name, td-headers-attr (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, input-image-alt, object-alt (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, listitem, td-has-header (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, meta-viewport, td-has-header (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, input-image-alt, select-name (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, meta-refresh, select-name (+11 more)

### Community 426 - "Community 426"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, empty-heading, label (+11 more)
...
Cohesion: 0.11
Nodes (19): audits, button-name, table-fake-caption, td-headers-attr, description, id, score, scoreDisplayMode (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, empty-heading, tabindex (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, label, td-headers-attr (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, accesskeys, duplicate-id-aria (+11 more)

### Community 438 - "Community 438"
Cohesion: 0.11
Nodes (19): custom-controls-labels, focusable-controls, input-button-name, description, id, score, scoreDisplayMode, title (+11 more)

### Community 439 - "Community 439"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, label, label-content-name-mismatch (+11 more)
...
Cohesion: 0.12
Nodes (16): description, id, score, scoreDisplayMode, title, aria-prohibited-attr, input-image-alt, list (+8 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, input-button-name, offscreen-content-hidden (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, custom-controls-labels, image-redundant-alt (+11 more)
...
Cohesion: 0.11
Nodes (19): empty-heading, meta-refresh, table-duplicate-name, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-parent, duplicate-id-aria, use-landmarks (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, custom-controls-roles, offscreen-content-hidden (+11 more)

### Community 467 - "Community 467"
Cohesion: 0.33
Nodes (6): managed-focus, description, id, score, scoreDisplayMode, title

### Community 468 - "Community 468"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-meter-name, bypass, logical-tab-order (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, empty-heading, table-duplicate-name (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, bypass, td-headers-attr (+11 more)

### Community 480 - "Community 480"
Cohesion: 0.11
Nodes (19): dlitem, empty-heading, input-button-name, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): image-redundant-alt, skip-link, valid-lang, description, id, score, scoreDisplayMode, title (+11 more)

### Community 483 - "Community 483"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, frame-title, identical-links-same-purpose (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, button-name, table-fake-caption (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-parent, empty-heading, table-duplicate-name (+11 more)
...
Cohesion: 0.11
Nodes (19): dlitem, meta-refresh, table-duplicate-name, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): empty-heading, html-xml-lang-mismatch, input-button-name, description, id, score, scoreDisplayMode, title (+11 more)

### Community 527 - "Community 527"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, dlitem, document-title (+11 more)

### Community 528 - "Community 528"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-input-field-name, focusable-controls (+11 more)

### Community 529 - "Community 529"
Cohesion: 0.11
Nodes (19): custom-controls-labels, frame-title, meta-refresh, description, id, score, scoreDisplayMode, title (+11 more)

### Community 530 - "Community 530"
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-text, bypass, definition-list (+17 more)

### Community 531 - "Community 531"
Cohesion: 0.11
Nodes (19): button-name, label-content-name-mismatch, link-in-text-block, description, id, score, scoreDisplayMode, title (+11 more)

### Community 532 - "Community 532"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, label-content-name-mismatch, select-name (+11 more)

### Community 533 - "Community 533"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, interactive-element-affordance, table-duplicate-name (+11 more)

### Community 534 - "Community 534"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, focus-traps, input-image-alt (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, definition-list (+11 more)

### Community 540 - "Community 540"
Cohesion: 0.11
Nodes (19): empty-heading, object-alt, th-has-data-cells, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, empty-heading (+11 more)

### Community 543 - "Community 543"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, button-name, image-alt (+11 more)
...
Cohesion: 0.33
Nodes (6): interactive-element-affordance, description, id, score, scoreDisplayMode, title

### Community 546 - "Community 546"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, html-xml-lang-mismatch, valid-lang (+11 more)
...
Cohesion: 0.29
Nodes (7): description, details, id, score, scoreDisplayMode, title, aria-allowed-attr

### Community 551 - "Community 551"
Cohesion: 0.33
Nodes (6): focusable-controls, description, id, score, scoreDisplayMode, title

### Community 552 - "Community 552"
Cohesion: 0.11
Nodes (19): form-field-multiple-labels, image-redundant-alt, tabindex, description, id, score, scoreDisplayMode, title (+11 more)

### Community 553 - "Community 553"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, empty-heading, focus-traps (+11 more)

### Community 554 - "Community 554"
Cohesion: 0.29
Nodes (7): description, details, id, score, scoreDisplayMode, title, aria-hidden-body

### Community 555 - "Community 555"
Cohesion: 0.11
Nodes (19): button-name, heading-order, listitem, description, id, score, scoreDisplayMode, title (+11 more)

### Community 556 - "Community 556"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, custom-controls-roles, link-name (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-meter-name, document-title (+11 more)
...
Cohesion: 0.11
Nodes (19): html-xml-lang-mismatch, image-alt, video-caption, description, id, score, scoreDisplayMode, title (+11 more)

### Community 562 - "Community 562"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, focus-traps, form-field-multiple-labels (+11 more)

### Community 563 - "Community 563"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, button-name, focusable-controls (+11 more)

### Community 564 - "Community 564"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, empty-heading, th-has-data-cells (+11 more)

### Community 565 - "Community 565"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, definition-list, object-alt (+11 more)

### Community 566 - "Community 566"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, input-image-alt (+11 more)
...
Cohesion: 0.29
Nodes (7): description, details, id, score, scoreDisplayMode, title, aria-hidden-focus

### Community 571 - "Community 571"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, html-xml-lang-mismatch, image-alt (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, custom-controls-labels, td-has-header (+11 more)
...
Cohesion: 0.11
Nodes (19): button-name, image-alt, tabindex, description, id, score, scoreDisplayMode, title (+11 more)

### Community 578 - "Community 578"
Cohesion: 0.11
Nodes (19): image-alt, label-content-name-mismatch, select-name, description, id, score, scoreDisplayMode, title (+11 more)

### Community 579 - "Community 579"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, definition-list, tabindex (+11 more)
...
Cohesion: 0.39
Nodes (6): AdminReservationsPage(), DEFAULT_FILTERS, fetchFinancials(), fetchReservations(), AdminReservationsPage, preloadAdminReservationsPage()
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-input-field-name, html-xml-lang-mismatch, link-name (+11 more)
...
Cohesion: 0.11
Nodes (19): custom-controls-roles, frame-title, object-alt, description, id, score, scoreDisplayMode, title (+11 more)

### Community 588 - "Community 588"
Cohesion: 0.11
Nodes (19): audits, dlitem, interactive-element-affordance, object-alt, description, id, score, scoreDisplayMode (+11 more)

### Community 589 - "Community 589"
Cohesion: 0.08
Nodes (25): description, id, score, scoreDisplayMode, title, aria-progressbar-name, image-alt, listitem (+17 more)

### Community 590 - "Community 590"
Cohesion: 0.29
Nodes (7): document-title, description, details, id, score, scoreDisplayMode, title

### Community 591 - "Community 591"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, focusable-controls, input-image-alt (+11 more)
...
Cohesion: 0.10
Nodes (20): label, link-in-text-block, list, valid-lang, description, id, score, scoreDisplayMode (+12 more)
...
Cohesion: 0.29
Nodes (7): landmark-one-main, description, details, id, score, scoreDisplayMode, title
...
Cohesion: 0.11
Nodes (19): audits, definition-list, duplicate-id-aria, html-xml-lang-mismatch, description, id, score, scoreDisplayMode (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-role, interactive-element-affordance, select-name (+11 more)

### Community 608 - "Community 608"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-command-name, definition-list, tabindex (+11 more)
...
Cohesion: 0.11
Nodes (19): custom-controls-labels, image-alt, td-has-header, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-treeitem-name, frame-title, valid-lang (+11 more)
...
Cohesion: 0.11
Nodes (19): button-name, focusable-controls, input-image-alt, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-attr, bypass, dlitem (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, duplicate-id-aria (+11 more)
...
Cohesion: 0.12
Nodes (16): description, id, score, scoreDisplayMode, title, aria-required-attr, list, table-duplicate-name (+8 more)
...
Cohesion: 0.12
Nodes (15): 1. `20260421175000_create_property_nightly_prices.sql` — HARD FAILURE, `20260319153000_drop_booking_deposit_status.sql` runs BEFORE `20260319_create_bookings.sql`, 2. `20260421144000_add_properties_lat_lng.sql` — SILENT FAILURE, 3. `20260423102000_add_properties_guesty_listing_id.sql` — SILENT FAILURE, 4. `20260426093000_add_properties_accommodates.sql` — SILENT FAILURE (partial), 5. `20260319_create_bookings.sql` — NAMING INCONSISTENCY, 6. `20260512060000_add_pms_provider_columns.sql` — NAMING INCONSISTENCY + DEAD CODE, Broken Migrations — Full Reference List (+7 more)

### Community 650 - "Community 650"
Cohesion: 0.29
Nodes (7): description, details, id, score, scoreDisplayMode, title, aria-valid-attr

### Community 651 - "Community 651"
Cohesion: 0.14
Nodes (14): description, id, score, scoreDisplayMode, title, description, id, score (+6 more)

### Community 652 - "Community 652"
Cohesion: 0.14
Nodes (14): interactive-element-affordance, list, valid-lang, description, id, score, scoreDisplayMode, title (+6 more)

### Community 653 - "Community 653"
Cohesion: 0.14
Nodes (14): description, id, score, scoreDisplayMode, title, aria-required-attr, list, tabindex (+6 more)
...
Cohesion: 0.14
Nodes (14): form-field-multiple-labels, label-content-name-mismatch, list, description, id, score, scoreDisplayMode, title (+6 more)
...
Cohesion: 0.35
Nodes (9): buildEmailHtml(), escapeHtml(), fieldRows(), getRecipients(), handler(), isEmail(), jsonResponse(), multiline() (+1 more)

### Community 670 - "Community 670"
Cohesion: 0.09
Nodes (42): filterVisibleUnits(), HIDDEN_CITY_TERMS, includesHiddenCity(), isHiddenCityUnit(), normalizeHiddenText(), buildListingInfoUrl(), buildListingPageUrl(), resolvePublicSiteBase() (+34 more)
...
Cohesion: 0.33
Nodes (7): CITY_HIGHLIGHTS, getCityHighlights(), buildHighlightDocs(), buildHighlightDocs(), HighlightIcon(), NeighborhoodHighlightsSection(), NEIGHBORHOOD_HIGHLIGHTS
...
Cohesion: 0.29
Nodes (7): html-has-lang, description, details, id, score, scoreDisplayMode, title
...
Cohesion: 0.33
Nodes (6): focus-traps, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.33
Nodes (6): use-landmarks, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.33
Nodes (6): offscreen-content-hidden, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.33
Nodes (6): visual-order-follows-dom, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.11
Nodes (19): html-xml-lang-mismatch, identical-links-same-purpose, td-headers-attr, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.10
Nodes (21): audits, button-name, link-in-text-block, td-has-header, valid-lang, description, id, score (+13 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, tabindex, td-headers-attr (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, accesskeys, identical-links-same-purpose (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-progressbar-name, meta-refresh, object-alt (+11 more)
...
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-dialog-name, form-field-multiple-labels, input-button-name (+12 more)
...
Cohesion: 0.33
Nodes (6): logical-tab-order, description, id, score, scoreDisplayMode, title
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, accesskeys, bypass, dlitem (+11 more)

### Community 1652 - "Community 1652"
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-allowed-attr, managed-focus, table-duplicate-name (+11 more)
...
Cohesion: 0.12
Nodes (16): audits, form-field-multiple-labels, label-content-name-mismatch, list, use-landmarks, description, id, score (+8 more)
...
Cohesion: 0.11
Nodes (19): audits, duplicate-id-aria, html-xml-lang-mismatch, image-alt, description, id, score, scoreDisplayMode (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, dlitem, meta-refresh (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-allowed-role, custom-controls-labels (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-progressbar-name, form-field-multiple-labels (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-conditional-attr, form-field-multiple-labels, tabindex (+11 more)
...
Cohesion: 0.10
Nodes (20): label, link-in-text-block, list, th-has-data-cells, description, id, score, scoreDisplayMode (+12 more)
...
Cohesion: 0.11
Nodes (19): audits, dlitem, interactive-element-affordance, select-name, description, id, score, scoreDisplayMode (+11 more)
...
Cohesion: 0.14
Nodes (14): focus-traps, list, th-has-data-cells, description, id, score, scoreDisplayMode, title (+6 more)
...
Cohesion: 0.29
Nodes (7): description, details, id, score, scoreDisplayMode, title, aria-deprecated-role
...
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, audits, aria-allowed-attr, bypass (+12 more)
...
Cohesion: 0.11
Nodes (19): focusable-controls, input-image-alt, tabindex, description, id, score, scoreDisplayMode, title (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, aria-required-children, duplicate-id-aria, empty-heading (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-treeitem-name, definition-list (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-treeitem-name, focus-traps (+11 more)
...
Cohesion: 0.10
Nodes (20): description, id, score, scoreDisplayMode, title, aria-hidden-focus, definition-list, link-name (+12 more)
...
Cohesion: 0.11
Nodes (19): audits, link-in-text-block, object-alt, select-name, description, id, score, scoreDisplayMode (+11 more)
...
Cohesion: 0.11
Nodes (19): description, id, score, scoreDisplayMode, title, audits, aria-conditional-attr, input-button-name (+11 more)
...
## Knowledge Gaps
- **24019 isolated node(s):** `PreToolUse`, `allow`, `lighthouseVersion`, `requestedUrl`, `mainDocumentUrl` (+24014 more)
...
- **Why does `audits` connect `Community 270` to `Community 3334`, `Community 3336`, `Community 3337`, `Community 271`, `Community 272`, `Community 3345`, `Community 3346`, `Community 3347`, `Community 3348`, `Community 3349`, `Community 273`, `Community 3350`, `Community 3352`, `Community 3351`, `Community 3353`, `Community 3354`, `Community 3355`, `Community 3356`, `Community 3358`, `Community 3357`, `Community 3359`, `Community 3361`, `Community 3360`, `Community 3362`, `Community 3363`, `Community 3364`, `Community 3366`, `Community 3365`, `Community 3367`, `Community 3368`, `Community 3369`, `Community 3499`, `Community 3372`, `Community 3371`, `Community 3370`, `Community 3373`, `Community 3374`, `Community 3375`, `Community 3378`, `Community 3376`, `Community 3502`, `Community 3377`, `Community 3508`, `Community 3379`, `Community 3380`, `Community 3510`, `Community 3381`, `Community 3382`, `Community 323`, `Community 76`, `Community 78`, `Community 213`, `Community 3325`, `Community 3327`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `PrivacyPolicy` connect `Community 10` to `Community 289`, `Community 91`, `Community 11`, `Community 3493`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `CaliforniaPrivacyPolicy` connect `Community 8` to `Community 1915`, `Community 91`, `Community 11`, `Community 443`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `PreToolUse`, `allow`, `lighthouseVersion` to the rest of the system?**
  _24019 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.029639175257731958 - nodes in this community are weakly interconnected._
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0320038213518032 - nodes in this community are weakly interconnected._
