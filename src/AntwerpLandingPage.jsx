...
const ANTWERP_REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    source: "Guest",
    quote: "Diamond District views were perfect. The space felt modern and calm.",
  },
];
...
const GOOGLE_REVIEW_LINKS = {
  "antwerp-diamond":
    "https://www.google.com/travel/search?q=One%20Lux%20Stay%20Antwerp&qs=CAAgACgAMihDaG9JeHAtYzFyN3h3YlNrQVJvTkwyY3ZNVEZxZEROb2NHTm9PUkFCOA1IAA&ts=CAEaOgoaEhgKDS9nLzExczhfbHB3Zjk6B0FudHdlcnASHBIUCgcI6g8QAhgTEgcI6g8QAhgUGAEyBAgAEAAqBwoFOgNQSFA&ap=KigKEgkAH9u3HgdBQBG_B5T5ho9dwBISCeugdTubB0FAEb8HFE9Ij13AMAC6AQdyZXZpZXdz",
  "antwerp-near-central": "",
  "antwerp-central": "",
  "antwerp-fashion": "",
  "antwerp-city-centre":
    "https://www.google.com/travel/search?q=one%20lux%20stay%20antwerp%20city%20centre%20reviews&gsas=1&qs=CAAgACgAMidDaGtJcWRQWndOT0dycHBIR2cwdlp5OHhNWE00WDJ4d2QyWTVFQUVIAA&tcfs=EjIKDS9nLzExczhfbHB3ZjkSB0FudHdlcnAaGAoKMjAyNi0wMi0xORIKMjAyNi0wMi0yMFIA&ts=CAEaOQodEhs6GVF1ZXpvbiBDaXR5LCBNZXRybyBNYW5pbGESGBISCgcI6g8QAhgWEgcI6g8QAhgXMgIIAioHCgU6A1BIUA&ap=KigKEglu7rvqeJ1JQBHQWPvmXaMRQBISCcmk33GQnUlAEdBY-5BYpBFAMAC6AQdyZXZpZXdz",
};
...
export default function AntwerpLandingPage() {
  const promoConfig = usePromoConfig("antwerp");
  const {
...
const [checkoutPromoCode, setCheckoutPromoCode] = useState("");
  ...
  const handlePromoSelection = async ({ listingId, planId }) => {
    ...
    try {
      const result = await validatePromoExtension({
        planId,
        checkIn: sectionCheckIn,
        checkOut: sectionCheckOut,
        listingIds: ids.length ? ids : [listingId],
      ...
      <section className="la-listing-hero la-listing-hero--mobile-top-logo">
        ...
        <div className="la-listing-hero__intro">
          <div>
            ...
            <h3>{activeListing?.title || formatListingLocationLabel(activeListing, "Antwerp")}</h3>
